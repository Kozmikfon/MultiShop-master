...
// React/SPA anasayfa API'si için CORS
...
// Kök adres (/) anasayfa olarak React uygulamasına yönlendir
var reactAppUrl = app.Configuration["ReactAppUrl"] ?? "http://localhost:5173";
app.MapGet("/", () => Results.Redirect(reactAppUrl));
